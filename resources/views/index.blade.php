...
<body class="mainpage">
    ...
    <div class="fixappbox df">
        <div class="saopy df">
            ...
            <h5>Ilovani yuklab oling.</h5>
            <div class="apslink df">
                <div class="poltre"><a href="#" class="and__link btn-ripple"><i class="fa-brands fa-android"></i>
                        Android</a></div>
                <div class="poltre"><a href="#" class="ios__link btn-ripple"><i class="fa-brands fa-apple"></i> IOS</a>
                </div>
            </div>
        </div>
        <div class="apparrow df">
