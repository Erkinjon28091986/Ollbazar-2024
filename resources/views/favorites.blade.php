            ...
            <div class="tabcontent">
                ...
                <div class="tabitems">
                    <div class="data-text " id="data1">
                        <div class="chatcontainer favcont" id="chat-container-2">
                            <div id="selection-panel" class="panelhidden">
                                <div class="laredq df laredq2">
                                    <p class="laredtitle"></p>
                                    <div class="search-container ">
                                        ...
                                        <div class="search-input df" id="search-input">
                                            ...
                                            <a href="javascript:void(0)" id="closesearchinput"><i
                                                    class="icon-close"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="leftwrte df chatpanel">
                                    <span id="selected-info" class="selected-info favtanlandi">Tanlandi: 0</span>
                                    <div class="btnper df">
                                        <button id="pin-btn" style="display: none" class="pinbtn" title="ss"
                                            tooltip="Pin chat" flow="left">
                                            <p class="unpinbtn"></p>
                            ...
                            <div id="chat-list">
                                ...
                                <div class="chat-block" data-id="1">
                                    ...
                                    <div class="chat-info favinfo df">
                                    ...
                                    <div class="chat-status favstatus df">
                                        <a href="" class="removesubs" tooltip="Obunani bekor qilish" flow="left"><i
                                                class="icon-user-delete"></i></a>
                                ...
                                <div class="chat-block" data-id="2">
                                    ...
                                    <div class="chat-info favinfo df">
                                        <span class="chat-name">Komila Rahimova</span>
                                        <div class="rating-container">
                                            <div class="hrating r25"></div>
                        ...
                        <div class="masonry">
                            ...
                            <div class="item-elon">
                                ...
                                <a href="" class="elonimglink lot-image-flashelon">
                                    <img alt="Damas" src="placeholder.jpg"
                                        data-src="https://i.postimg.cc/HWF8QWyM/kuhn.jpg" class="lot-image  lazy">
                                </a>
                                <div class="lot-nav df">
                                    <div class="user-img-box">
                                        <img src="https://i.postimg.cc/nLSXjG8R/fjuyj.jpg" alt="Admin 2"
                    ...
                    <div class="chatcontainer favcont" id="chat-container-3">
                            <div id="selection-panel" class="panelhidden">
                                <div class="laredq df laredq2">
                                    <p class="laredtitle"></p>
                                    <div class="search-container ">
                            ...
                            <div id="chat-list">
                                ...
                                <div class="chat-block" data-id="1">
                                    <div class="flipbox df user-img-box">
                                        <div class="flipcheck storecheck"><i class="icon-ok"></i></div>
                                        <img src="https://i.postimg.cc/BvRm3mFr/image.jpg" alt="Avatar"
                                            class=" chatavatar storeavatar">
                                        <span class="status-user user-online"></span>
                                    </div>
                                   
                                    <div class="chat-info favinfo df">
                                        <a href="" class="chat-name">Wallmart</a>
                                        <div class="rating-container">
                                            <div class="hrating r45"></div>
                                            <span class="rating-value">4.5</span>
                                        </div>
                                    ...
                                    <div class="chat-status favstatus df">
                                        <a href="" class="removesubs storesubsremove" tooltip="Obunani bekor qilish" flow="left"><i
                                                class="icon-minus-2"></i></a>
                                        <div class="chatstfoot df">
                                            <span class="pinningbutton"><i class="icon-pin34"></i></span>
                                        </div>
                                    </div>
                                ...
                                <div class="chat-block" data-id="2">
                                    <div class="flipbox df user-img-box">
                                        <div class="flipcheck storecheck"><i class="icon-ok"></i></div>
                                        <img src="https://i.postimg.cc/ZKjjnb3F/image.jpg" alt="Avatar"
                                            class="storeavatar">
                                        <span class="status-user user-online"></span>
                                    </div>
                                    <div class="chat-info favinfo df">
                                        <a href="" class="chat-name">Target Corparation</a>
                                        <div class="rating-container">
                                            <div class="hrating r25"></div>
                                            <span class="rating-value">2.5</span>
                                        </div>
